...
namespace Condenser.ApiFirst.DocumentStorage.Api
{
    ...
    public partial class SwaggerDocumentStorage : ServiceClient<SwaggerDocumentStorage>, ISwaggerDocumentStorage
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the SwaggerDocumentStorage class.
        /// </summary>
        /// <param name='handlers'>
        ...
        public async Task<HttpOperationResponse<string>> SaveNewSwaggerDocWithHttpMessagesAsync(string agent, string serviceName, string serviceId, Schema swaggerDoc = default(Schema), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (agent == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "agent");
            }
            if (serviceName == null)
            {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/SwaggerDoc/{agent}/{serviceName}/{serviceId}").ToString();
            _url = _url.Replace("{agent}", System.Uri.EscapeDataString(agent));
            ...
            if(swaggerDoc != null)
            {
                _requestContent = SafeJsonConvert.SerializeObject(swaggerDoc, SerializationSettings);
